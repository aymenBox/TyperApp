...
var app = {
    ...
    onDeviceReady: function() {
        ...
        /*selecting a random quotes and assign it to the text variable*/
        var text = "";
        var tar="";
        var rand_quotes= Math.floor((Math.random() * 500));
        text = qoutes[rand_quotes];
        ...
        /*this function stars when the games end mistakes is the number of mistakes , tl is the text lenth */
        function endgame(mistakes,tl){
            inp=document.getElementById("myinp").value.length;
            res.innerHTML="You have written "+inp+" characters and made "+
            mistakes+" mistakes"+" over "+tl+" characters and you finished in "+(time-counter)+
        ...
        function play(){
            document.getElementById("myinp").disabled=false;
            document.getElementById("myinp").value="";
            document.getElementById("tmr").innerHTML=counter;
            document.getElementById("myinp").focus();
            /*the inter is a counter that update the counter element in the html page and 
            stop the game when the timer variable counter is 0  */
            var inter = setInterval(function(){
                counter--;
                document.getElementById("tmr").innerHTML=counter;
                if(counter==0 || playing==false){
                    clearInterval(inter);
                    endgame(mistakes,text.length);
        ...
        function check() 
        {
            ...
            if(char[char.length-1]==tar[i]){
                ...
                console.log(char[char.length-1],tar[i]);
                mistakes++;
